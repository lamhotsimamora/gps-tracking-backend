        ...
        var app = new Vue({
            ...
            methods: {
                login: function() {
                    ...
                    __({
                        url: SERVER+'api-login-mikrotik-user',
                        method: 'post',
                        data: {
                            ip: this.ip,
                        ...
                        if (obj.result) {
                            ...
                            _saveStorage("ip_user", this.ip);
                            _saveStorage("port_user", this.port);
                            _saveStorage("username_user", this.username);
                            _saveStorage("password_user", this.password);
                            _refresh(SERVER+"users-mikrotik-dashboard");
                        } else {
                            Swal.fire({
                                title: "Login Failed",
